...
export default function PasienKlinik() {
  ...
  return (
    <div>
      {/* HEADER */}
      <PageHeader title="Manajemen Pasien" breadcrumb={["Home", "Pasien"]} />
                ...
                >
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-3">
                      <AvatarKlinik name={p.nama} size="md" />
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#7A8DA3]">ID: {p.id}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  {/* LOYALITAS */}
                  <td className="p-3">
                    <BadgeStatus status={p.loyalitas} />
                  </td>
      ...
      {/* MODAL TAMBAH */}
      {showForm && (
        <Modal title="Tambah Pasien Baru" onClose={() => setShowForm(false)}>
          <form onSubmit={handleAddPasien}>
            ...
            <div className="flex gap-3 mt-4">
              <ButtonGradient type="submit" className="flex-1">
                Simpan
              </ButtonGradient>
      ...
      {showRiwayat && selectedPasien && (
        ...
        >
          <div className="mb-4 p-3 bg-gradient-to-r from-[#9FB2C8]/10 to-[#7A8DA3]/10 rounded-lg">
            <p>
              <strong>Status Loyalitas:</strong> {selectedPasien.loyalitas}
            </p>

            <p>
              <strong>Total Poin:</strong>{" "}
              {getTotalPoinPasien(selectedPasien.id)}
            </p>

            <p>
              <strong>Kunjungan Terakhir:</strong> {selectedPasien.lastVisit}
            </p>
          </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {dataTransaksi
                .filter((t) => t.pasienId === selectedPasien.id)
                .map((t) => (
