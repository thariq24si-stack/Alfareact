  ...
  return (
    <div>
      ...
      <button
        ...
        className="bg-gradient-to-r from-[#9FB2C8] to-[#7A8DA3] text-white px-4 py-2 rounded-lg flex items-center gap-2 mb-4 hover:opacity-90 transition"
      >
        <FaPlus />
        Tambah Pasien
      </button>
              ...
              >
                ...
                <td className="p-3 font-medium">
                  <Link
                    ...
                    className="text-[#5A7D9F] hover:underline"
                  >
                    {p.nama}
                  </Link>
                </td>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <form onSubmit={handleAddPasien}>
              ...
              <div className="flex gap-3">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-[#9FB2C8] to-[#7A8DA3] text-white px-4 py-2 rounded flex-1"
                >
                  Simpan
                </button>
